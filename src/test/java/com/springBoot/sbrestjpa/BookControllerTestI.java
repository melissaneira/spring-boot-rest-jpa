package com.springBoot.sbrestjpa;
...
import com.springBoot.sbrestjpa.Book;
...
@ActiveProfiles("test")
public class BookControllerTestI {
    ...
    @Test
    public void validUrl_shouldReturnOk() throws Exception {
      // Given
    ...
    @Test
    public void content_isNotAcceptable() throws Exception {
    	 final ResultActions result = mockMvc.perform(
    		        get("/books")
    ...
    @Test
    public void invalidUrl_shouldReturnNotFound() throws Exception {
    	 final ResultActions result = mockMvc.perform(
 		        get("/invalidURL")
 		            .accept(MimeTypeUtils.APPLICATION_JSON_VALUE));
